...
from PyQt5.QtWidgets import QTreeWidget, QLabel, QTreeWidgetItem, QWidget, QMainWindow, QApplication, QPushButton, QAbstractItemView
...
class TreeWidget(QMainWindow):
    def __init__(self,parent=None):
        ...
        for i in range(1,10):
            QTreeWidgetItem(self.tree) # 生成十行控件
        ...
        self.tree.setItemWidget(self.tree.topLevelItem(4),0,QPushButton("Push ME"))
        self.tree.setItemWidget(self.tree.topLevelItem(5),0,QPushButton("Push ME"))
        self.tree.setItemWidget(self.tree.topLevelItem(6),0,QPushButton("Push ME"))
        self.tree.setItemWidget(self.tree.topLevelItem(7),0,QPushButton("Push ME"))
...
class MyTree(QTreeWidget):
    ...
    def drawRow(self,painter,option,index):
        painter.save()
        brush = QBrush(QtGui.QColor(255,240,180))
